...
public class Order implements OrderProcessing
{
         ...
         throws OrderException
  {
    ...
    /*create an instance of class folder*/
         ...
         throws OrderException
  {
    ...
    for (Folder folder : folders) // for type folder, instance 'folder', searching all folders
    {
    	if( folder.getState() == State.BeingPicked && folder.getBasket().getOrderNum() == orderNum) //the folder must have state 'being picked' and the order number of that basket must be the same as the order number passed to the method
    	{
         ...
         throws OrderException
  {
    ...
    for (Folder folder : folders) // for type folder, instance 'folder', searching all folders
    {
    	if( folder.getState() == State.ToBeCollected && folder.getBasket().getOrderNum() == orderNum) //the folder must have state 'being picked' and the order number of that basket must be the same as the order number passed to the method
    	{
